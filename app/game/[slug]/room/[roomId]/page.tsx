    ...
    <GameStateGate slug={slug}>
      ...
      <div className="relative flex min-h-screen flex-col bg-zinc-950">
        ...
        <div className="sticky top-0 z-[60] w-full min-w-0 md:hidden">
          ...
          />
          <div className={`border-b ${rp.mapStripBorder} bg-zinc-950/95 px-3 pb-2 pt-2 shadow-[0_8px_24px_rgba(0,0,0,0.35)] backdrop-blur-md sm:px-4`}>
            <p className={`mb-1.5 text-center ${rp.mapTitle}`}>
              {t.hub.map}
            </p>
            <TempleMap
              slug={slug}
          ...
          <div className={`border-b ${rp.mapStripBorder} bg-zinc-950/95 px-3 pb-2 pt-1.5 backdrop-blur-md sm:px-4`}>
            <RoomMap
              slug={slug}
